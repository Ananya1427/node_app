...
// user controllers
const { createOrUpdateUser, getCurrentUser, checkUserRole, getUsers, registerRestaurant, getCurrentRestaurant, getRestaurants, getRestaurant, getRestaurantsByZip, modifyRestaurantStatus, createOrUpdateCuisine, getCuisine, getUserCuisines, deleteCuisine, createOrUpdateCart, getCart, createOrder, getOrders, getOrdersByDriver, getOrdersByRestaurant, getOrdersByUser, getUsersByRole, modifyOrderStatus } = require('../services/auth');
const { uploadImage, removeImage } = require('../services/images');
